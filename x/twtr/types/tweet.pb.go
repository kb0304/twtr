...
func (*Tweet) Descriptor() ([]byte, []int) {
	return fileDescriptor_57a7843152664077, []int{0}
}
...
func init() {
	proto.RegisterType((*Tweet)(nil), "kb0304.twtr.twtr.Tweet")
}

func init() { proto.RegisterFile("twtr/tweet.proto", fileDescriptor_57a7843152664077) }

var fileDescriptor_57a7843152664077 = []byte{
	// 170 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x28, 0x29, 0x2f, 0x29,
	0xd2, 0x2f, 0x29, 0x4f, 0x4d, 0x2d, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xc8, 0x4e,
	0x32, 0x30, 0x36, 0x30, 0xd1, 0x03, 0x49, 0x80, 0x09, 0x25, 0x57, 0x2e, 0xd6, 0x10, 0x90, 0x02,
	...
	0x88, 0x29, 0x33, 0x45, 0x48, 0x88, 0x8b, 0x25, 0x29, 0x3f, 0xa5, 0x52, 0x82, 0x19, 0xac, 0x0c,
	0xcc, 0x76, 0xb2, 0x3d, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18,
	0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0xe5, 0xf4,
	0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x88, 0xed, 0xfa, 0x60, 0x67, 0x55,
	0x40, 0xa8, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0xf3, 0x8c, 0x01, 0x01, 0x00, 0x00,
	0xff, 0xff, 0x14, 0xd9, 0x30, 0xf9, 0xb2, 0x00, 0x00, 0x00,
}
...
func (m *Tweet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Body) > 0 {
		i -= len(m.Body)
		copy(dAtA[i:], m.Body)
		i = encodeVarintTweet(dAtA, i, uint64(len(m.Body)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
